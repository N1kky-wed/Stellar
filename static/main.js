...
const defaultAgentSettings = {
  logs_and_preferences: true,
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        function updateMemoryTokenFootprint() {
          ...
          fetch("/api/utils/count_tokens", {
            ...
            .then((res) => res.json())
            .then((data) => {
              const footprintEl = document.getElementById(
                "memoryTokenFootprint",
              );
        ...
        if (closeLogsPrefsBtn)
          closeLogsPrefsBtn.onclick = () =>
            (logsPrefsModal.style.display = "none");
      ...
      const regenerateModalTitle = document.getElementById(
      ...
      const openAgentSettingsBtn = document.getElementById(
        "openAgentSettingsBtn",
      );
      const agentSettingsCloseBtn = document.getElementById(
        "agentSettingsCloseBtn",
      );
      ...
      const passwordChangeMessage = document.getElementById(
        "passwordChangeMessage",
      );
      const logoutButtonProfile = document.getElementById(
        "logoutButtonProfile",
      );
      const sidebarUsername = document.getElementById("sidebarUsername");
      const tokenCountBar = document.getElementById("tokenCountBar");
      const stagedFilesContainer = document.getElementById(
        "stagedFilesContainer",
      );
      const chatScrollToBottomBtn = document.getElementById(
        ...
        globalEventSource.onmessage = (e) => {
          ...
          if (data.type === "new_message") {
            if (data.chat_id === currentChatId && !data.message.hidden) {
              ...
              if (
                document.querySelector(`.message[data-id="${data.message.id}"]`)
              )
                return;
      ...
      const modelThemes = {
        emerald: {
          ...
          border: "rgba(0, 194, 146, 0.6)",
          shadow: "rgba(0, 194, 146, 0.3)",
          inset: "rgba(0, 194, 146, 0.2)",
          h_start: "#00a77d",
          h_end: "#00c292",
          h_border: "rgba(0, 194, 146, 0.8)",
          h_shadow: "rgba(0, 194, 146, 0.5)",
          h_inset: "rgba(0, 194, 146, 0.3)",
          h_strong: "rgba(0, 194, 146, 0.4)",
          titleShadow: "rgba(0, 100, 80, 0.4)",
          bodyBg1: "#0a2e26",
          bodyBg2: "#0f4d3f",
          bodyBg3: "#146d59",
          bodyBg4: "#0f4d3f",
          primaryText: "#e0fdf6",
          secondaryText: "#94d9c9",
          headerBg: "rgba(10, 46, 38, 0.4)",
          headerBorder: "rgba(0, 194, 146, 0.2)",
          inputBg: "rgba(10, 46, 38, 0.5)",
          inputBorder: "rgba(0, 194, 146, 0.15)",
          inputFocusBg: "rgba(15, 77, 63, 0.6)",
          userMsgBg: "rgba(0, 194, 146, 0.1)",
          userMsgBorder: "rgba(0, 194, 146, 0.3)",
          userMsgHoverBg: "rgba(0, 194, 146, 0.15)",
          stellarMsgBg: "rgba(0, 50, 40, 0.3)",
          stellarMsgBorder: "rgba(0, 194, 146, 0.2)",
          stellarMsgHoverBg: "rgba(0, 60, 50, 0.4)",
          tableBorder: "rgba(0, 194, 146, 0.4)",
          codeBg: "rgba(5, 30, 25, 0.9)",
          codeBorder: "rgba(0, 194, 146, 0.5)",
          codeText: "#e8fff8",
          inlineCodeText: "#50e3c2",
          copyBtnBg: "rgba(0, 194, 146, 0.15)",
          copyBtnHoverBg: "rgba(0, 194, 146, 0.25)",
          copyBtnColor: "#a7f5e3",
          copyBtnHoverColor: "#e8fff8",
          copyBtnCopiedBg: "#00a77d",
          copyBtnCopiedColor: "#ffffff",
          scrollbarTrack: "rgba(15, 77, 63, 0.7)",
          previewBtnBg: "rgba(0, 194, 146, 0.15)",
          previewBtnHoverBg: "rgba(0, 194, 146, 0.25)",
          previewBtnColor: "#a7f5e3",
          previewBtnHoverColor: "#e8fff8",
          tokenLow: "#00c292",
          tokenMedium: "#00a77d",
          tokenHigh: "#d31027",
        },
        lunarity: {
          start_rgb: "123, 97, 255",
          start: "#7b61ff",
          end: "#b554ff",
          border: "rgba(181, 84, 255, 0.5)",
          shadow: "rgba(123, 97, 255, 0.3)",
          inset: "rgba(123, 97, 255, 0.2)",
          h_start: "#b554ff",
          h_end: "#7b61ff",
          h_border: "rgba(123, 97, 255, 0.7)",
          h_shadow: "rgba(123, 97, 255, 0.5)",
          h_inset: "rgba(123, 97, 255, 0.3)",
          h_strong: "rgba(123, 97, 255, 0.4)",
          titleShadow: "rgba(123, 97, 255, 0.3)",
          bodyBg1: "#0f0c29",
          bodyBg2: "#302b63",
          bodyBg3: "#24243e",
          bodyBg4: "#302b63",
          primaryText: "#f0f0f0",
          secondaryText: "#a9a3c7",
          headerBg: "rgba(20, 16, 50, 0.3)",
          headerBorder: "rgba(181, 84, 255, 0.15)",
          inputBg: "rgba(20, 16, 50, 0.4)",
          inputBorder: "rgba(181, 84, 255, 0.1)",
          inputFocusBg: "rgba(30, 26, 60, 0.5)",
          userMsgBg: "rgba(123, 97, 255, 0.15)",
          userMsgBorder: "rgba(123, 97, 255, 0.3)",
          userMsgHoverBg: "rgba(123, 97, 255, 0.2)",
          stellarMsgBg: "rgba(0, 0, 0, 0.25)",
          stellarMsgBorder: "rgba(123, 97, 255, 0.2)",
          stellarMsgHoverBg: "rgba(0, 0, 0, 0.35)",
          tableBorder: "rgba(123, 97, 255, 0.3)",
          codeBg: "rgba(10, 10, 25, 0.85)",
          codeBorder: "rgba(123, 97, 255, 0.4)",
          codeText: "#f5f5f5",
          inlineCodeText: "#cea9ff",
          copyBtnBg: "rgba(255, 255, 255, 0.1)",
          copyBtnHoverBg: "rgba(255, 255, 255, 0.2)",
          copyBtnColor: "#c5bfff",
          copyBtnHoverColor: "#f5f5f5",
          copyBtnCopiedBg: "#7b61ff",
          copyBtnCopiedColor: "#ffffff",
          scrollbarTrack: "rgba(36, 36, 62, 0.8)",
          previewBtnBg: "rgba(255, 255, 255, 0.1)",
          previewBtnHoverBg: "rgba(255, 255, 255, 0.2)",
          previewBtnColor: "#c5bfff",
          previewBtnHoverColor: "#f5f5f5",
          tokenLow: "#7b61ff",
          tokenMedium: "#b554ff",
          tokenHigh: "#ff6b6b",
        },
        crimson: {
          ...
          border: "rgba(211, 16, 39, 0.6)",
          shadow: "rgba(211, 16, 39, 0.3)",
          inset: "rgba(211, 16, 39, 0.2)",
          h_start: "#9A0007",
          h_end: "#D31027",
          h_border: "rgba(211, 16, 39, 0.8)",
          h_shadow: "rgba(211, 16, 39, 0.5)",
          h_inset: "rgba(211, 16, 39, 0.3)",
          h_strong: "rgba(211, 16, 39, 0.4)",
          titleShadow: "rgba(100, 0, 0, 0.4)",
          bodyBg1: "#2b0404",
          bodyBg2: "#4d0a0a",
          bodyBg3: "#6f1010",
          bodyBg4: "#4d0a0a",
          primaryText: "#ffebee",
          secondaryText: "#f7c4c4",
          headerBg: "rgba(43, 4, 4, 0.4)",
          headerBorder: "rgba(211, 16, 39, 0.2)",
          inputBg: "rgba(43, 4, 4, 0.5)",
          inputBorder: "rgba(211, 16, 39, 0.15)",
          inputFocusBg: "rgba(77, 10, 10, 0.6)",
          userMsgBg: "rgba(211, 16, 39, 0.1)",
          userMsgBorder: "rgba(211, 16, 39, 0.3)",
          userMsgHoverBg: "rgba(211, 16, 39, 0.15)",
          stellarMsgBg: "rgba(50, 0, 0, 0.3)",
          stellarMsgBorder: "rgba(211, 16, 39, 0.2)",
          stellarMsgHoverBg: "rgba(60, 0, 0, 0.4)",
          tableBorder: "rgba(211, 16, 39, 0.4)",
          codeBg: "rgba(40, 5, 5, 0.9)",
          codeBorder: "rgba(211, 16, 39, 0.5)",
          codeText: "#ffebee",
          inlineCodeText: "#ff8a80",
          copyBtnBg: "rgba(211, 16, 39, 0.15)",
          copyBtnHoverBg: "rgba(211, 16, 39, 0.25)",
          copyBtnColor: "#ffcdd2",
          copyBtnHoverColor: "#ffebee",
          copyBtnCopiedBg: "#9A0007",
          copyBtnCopiedColor: "#ffffff",
          scrollbarTrack: "rgba(77, 10, 10, 0.7)",
          previewBtnBg: "rgba(211, 16, 39, 0.15)",
          previewBtnHoverBg: "rgba(211, 16, 39, 0.25)",
          previewBtnColor: "#ffcdd2",
          previewBtnHoverColor: "#ffebee",
          tokenLow: "#D31027",
          tokenMedium: "#ff512f",
          tokenHigh: "#fffb00",
        },
        obsidian: {
          ...
          border: "rgba(72, 85, 99, 0.6)",
          shadow: "rgba(72, 85, 99, 0.4)",
          inset: "rgba(72, 85, 99, 0.2)",
          h_start: "#29323c",
          h_end: "#485563",
          h_border: "rgba(72, 85, 99, 0.8)",
          h_shadow: "rgba(72, 85, 99, 0.6)",
          h_inset: "rgba(72, 85, 99, 0.3)",
          h_strong: "rgba(72, 85, 99, 0.5)",
          ...
          headerBg: "rgba(26, 32, 39, 0.4)",
          headerBorder: "rgba(72, 85, 99, 0.2)",
          inputBg: "rgba(26, 32, 39, 0.5)",
          inputBorder: "rgba(72, 85, 99, 0.15)",
          inputFocusBg: "rgba(44, 62, 80, 0.6)",
          userMsgBg: "rgba(72, 85, 99, 0.1)",
          userMsgBorder: "rgba(72, 85, 99, 0.3)",
          userMsgHoverBg: "rgba(72, 85, 99, 0.15)",
          stellarMsgBg: "rgba(20, 30, 40, 0.3)",
          stellarMsgBorder: "rgba(72, 85, 99, 0.2)",
          stellarMsgHoverBg: "rgba(30, 40, 50, 0.4)",
          tableBorder: "rgba(72, 85, 99, 0.4)",
          codeBg: "rgba(15, 22, 30, 1)",
          codeBorder: "rgba(72, 85, 99, 0.6)",
          codeText: "#eceff1",
          inlineCodeText: "#cfd8dc",
          copyBtnBg: "rgba(72, 85, 99, 0.2)",
          copyBtnHoverBg: "rgba(72, 85, 99, 0.3)",
          copyBtnColor: "#b0bec5",
          copyBtnHoverColor: "#eceff1",
          copyBtnCopiedBg: "#29323c",
          copyBtnCopiedColor: "#ffffff",
          scrollbarTrack: "rgba(44, 62, 80, 0.7)",
          previewBtnBg: "rgba(72, 85, 99, 0.2)",
          previewBtnHoverBg: "rgba(72, 85, 99, 0.3)",
          previewBtnColor: "#b0bec5",
          previewBtnHoverColor: "#eceff1",
          tokenLow: "#485563",
          tokenMedium: "#6e7a85",
          tokenHigh: "#f3c700",
        },
      ...
      function scrollToBottom() {
        ...
        scrollTargets.forEach((target) => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              if (
                target.el.scrollTop + element.clientHeight <
                scrollHeight - 100
              ) {
      ...
      messagesDiv.addEventListener("click", async function (event) {
        ...
        if (downloadButton) {
          ...
          const codeContentWrapper = downloadButton.closest(
      ...
      async function executeCode(
        ...
        try {
          ...
          const outputPanel = outputContentDiv.closest(
            ...
            .then(() => {
              ...
              setTimeout(() => {
                ...
                setTimeout(
                  ...
                  parseFloat(getComputedStyle(tooltip).transitionDuration) *
                    1000 || 150,
                );
              }, 1500);
            })
      ...
      async function deleteMessageFromServer(messageId, messageElement) {
        try {
          ...
          if (response.ok) {
            ...
            alert(
              "Failed to delete message: " + (err.error || "Unknown error"),
            );
          }
        } catch (e) {
          ...
          saveButton.addEventListener("click", async () => {
            ...
            try {
              ...
              if (!response.ok) {
                ...
                throw new Error(
                  errData.error || "Failed to update chat history.",
                );
              }
      ...
      function createAndAppendResearchButtons(
        ...
        if (
          !msgContainer ||
          !msgContainer.classList.contains("research-output")
        )
          return;
        const existingButtonsDiv =
          msgContainer.querySelector(".message-buttons");
      ...
      function updateFavicon() {
        ...
        const analysisAreaHasContent =
          document.getElementById("analysis-progress-area")?.childElementCount >
          0;
      ...
      function updateModelSelectTheme() {
        ...
        if (selectedOption) {
          ...
          const themeName = selectedOption.text
            .toLowerCase()
            .replace(/\s+/g, "-");
          const theme =
            modelThemes[modelKey] ||
            modelThemes[themeName] ||
            modelThemes.lunarity;
          ...
          Object.keys(theme).forEach((key) => {
            ...
            if (key.startsWith("h_")) {
              if (key === "h_strong")
                cssVarName = "--model-hover-shadow-strong";
              else if (key === "h_inset")
                cssVarName = "--model-hover-color-shadow-inset";
              else if (key === "h_shadow")
                cssVarName = "--model-hover-color-shadow";
              else if (key === "h_border")
                cssVarName = "--model-hover-color-border";
              else
                cssVarName = `--model-hover-color-${key.substring(2).replace("_", "-")}`;
            } else if (
              ["start", "end", "border", "shadow", "inset"].includes(key)
            ) {
              cssVarName = `--model-color-${key.replace("_", "-")}`;
            } else {
              switch (key) {
                case "bodyBg1":
                  cssVarName = "--body-bg-color1";
                  break;
                case "bodyBg2":
                  cssVarName = "--body-bg-color2";
                  break;
                case "bodyBg3":
                  cssVarName = "--body-bg-color3";
                  break;
                case "bodyBg4":
                  cssVarName = "--body-bg-color4";
                  break;
                case "titleShadow":
                  cssVarName = "--title-shadow-color";
                  break;
                case "primaryText":
                  cssVarName = "--primary-text-color";
                  break;
                case "secondaryText":
                  cssVarName = "--secondary-text-color";
                  break;
                case "headerBg":
                  cssVarName = "--header-bg";
                  break;
                case "headerBorder":
                  cssVarName = "--header-border";
                  break;
                case "inputBg":
                  cssVarName = "--input-bg";
                  break;
                case "inputBorder":
                  cssVarName = "--input-border";
                  break;
                case "inputFocusBg":
                  cssVarName = "--input-focus-bg";
                  break;
                case "userMsgBg":
                  cssVarName = "--user-msg-bg";
                  break;
                case "userMsgBorder":
                  cssVarName = "--user-msg-border";
                  break;
                case "userMsgHoverBg":
                  cssVarName = "--user-msg-hover-bg";
                  break;
                case "stellarMsgBg":
                  cssVarName = "--stellar-msg-bg";
                  break;
                case "stellarMsgBorder":
                  cssVarName = "--stellar-msg-border";
                  break;
                case "stellarMsgHoverBg":
                  cssVarName = "--stellar-msg-hover-bg";
                  break;
                case "tableBorder":
                  cssVarName = "--table-border-color";
                  break;
                case "codeBg":
                  cssVarName = "--code-bg";
                  break;
                case "codeBorder":
                  cssVarName = "--code-border";
                  break;
                case "codeText":
                  cssVarName = "--code-text-color";
                  break;
                case "inlineCodeText":
                  cssVarName = "--inline-code-text-color";
                  break;
                case "copyBtnBg":
                  cssVarName = "--code-btn-bg";
                  break;
                case "copyBtnHoverBg":
                  cssVarName = "--code-btn-hover-bg";
                  break;
                case "copyBtnColor":
                  cssVarName = "--code-btn-color";
                  break;
                case "copyBtnHoverColor":
                  cssVarName = "--code-btn-hover-color";
                  break;
                case "copyBtnCopiedBg":
                  cssVarName = "--copy-btn-copied-bg";
                  break;
                case "copyBtnCopiedColor":
                  cssVarName = "--copy-btn-copied-color";
                  break;
                case "scrollbarTrack":
                  cssVarName = "--scrollbar-track-bg";
                  break;
                case "previewBtnBg":
                  cssVarName = "--preview-btn-bg";
                  break;
                case "previewBtnHoverBg":
                  cssVarName = "--preview-btn-hover-bg";
                  break;
                case "previewBtnColor":
                  cssVarName = "--preview-btn-color";
                  break;
                case "previewBtnHoverColor":
                  cssVarName = "--preview-btn-hover-color";
                  break;
                case "tokenLow":
                  cssVarName = "--token-bar-fill-low";
                  break;
                case "tokenMedium":
                  cssVarName = "--token-bar-fill-medium";
                  break;
                case "tokenHigh":
                  cssVarName = "--token-bar-fill-high";
                  break;
                default:
                  cssVarName = null;
              }
            ...
            if (key === "start_rgb") {
              root.style.setProperty("--model-color-start-rgb", theme[key]);
            }
          });
          ...
          root.style.setProperty(
            "--inline-code-bg",
            theme.stellarMsgBg || "rgba(0,0,0, 0.3)",
          );
          ...
          root.style.setProperty(
            "--output-copy-btn-bg",
            theme.copyBtnBg || "rgba(50, 50, 50, 0.7)",
          );
          root.style.setProperty(
            "--output-copy-btn-hover-bg",
            theme.copyBtnHoverBg || "rgba(70, 70, 70, 0.8)",
          );
          root.style.setProperty(
            "--output-copy-btn-color",
            theme.secondaryText || "#d1d5db",
          );
          root.style.setProperty(
            "--output-copy-btn-hover-color",
            theme.primaryText || "#ffffff",
          );
          root.style.setProperty(
            "--output-copy-btn-copied-bg",
            theme.start || "#20a375",
          );
          ...
          if (glow1)
            glow1.style.background = `radial-gradient(circle, ${theme.start}99 0%, rgba(123, 97, 255, 0) 70%)`;
          if (glow2)
            glow2.style.background = `radial-gradient(circle, ${theme.end}99 0%, rgba(181, 84, 255, 0) 70%)`;
        }
        updateFavicon();
      }
      ...
      async function handleSend(silent = false) {
        ...
        if (currentChatId) {
          ...
          if (
            activeChatItem &&
            chatList &&
            chatList.firstChild !== activeChatItem
          ) {
        ...
        if (hasFilesToSend) {
          ...
          try {
            ...
            if (
              uploadData.uploaded_files &&
              uploadData.uploaded_files.length > 0
            ) {
      ...
      function updateStellarMessagePlaceholder(
        ...
        if (statusSpan) {
          ...
          const currentActiveItem = statusSpan.querySelector(
            ".status-item.active",
          );
          ...
          if (
            ...
            if (currentActiveItem) {
              ...
              if (isError) {
                ...
                currentActiveItem.querySelector(
      ...
      function renderPresentationViewer(container, data) {
        ...
        const feedbackInput = feedbackOverlay.querySelector(
          ".pres-feedback-input",
        );
      ...
      function unwrapVisuals(container) {
        ...
        container
          .querySelectorAll("pre code, .message-content")
          .forEach((el) => {
                ...
                if (isFinalMessage) {
                  ...
                  if (data.status === "display_result" && data.file_url) {
                    ...
                    if (
                      ...
                      if (buttonsDiv) {
                        let viewBtn =
                          buttonsDiv.querySelector(" .view-html-btn");
                        if (!viewBtn) {
                  ...
                  const numMessagesInChat = Array.from(
      ...
      function cleanupStream(
        ...
        const latestUserMessage = [
          ...document.querySelectorAll(".user-msg"),
        ].pop();
        ...
        try {
          ...
          if (chats.length > 0) {
            chats.forEach((chat) => {
              ...
              li.querySelector(".delete-chat-btn").addEventListener(
                "click",
                (e) => {
                  e.stopPropagation();
      ...
      const closeAdminWaitlistBtn = document.getElementById(
      ...
      function removeHighlightFromMessage(messageElement) {
        ...
        const highlightedSpans =
          contentDiv.querySelectorAll(".highlighted-text");
          ...
          if (SpeechRecognition && voiceInputBtn) {
            ...
            const startListening = async () => {
              ...
              try {
                ...
                smoothedDataArray = new Array(analyser.frequencyBinCount).fill(
                  0,
                );
      ...
      function showLivePreview(url) {
        ...
        if (!container || !iframe || !title || !fallback || !fallbackLink)
          return;
      ...
      async function handleStopGeneration() {
        ...
        if (currentStreamQueryId) {
          ...
          placeholderId = document.querySelector(".placeholder-message")
            ?.dataset.id;
        }
