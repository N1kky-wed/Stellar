...
!(function (e, t) {
  ...
  const i = {
    ...
    U = { normal: w, gfm: y, pedantic: $ },
    J = { normal: G, gfm: X, breaks: F, pedantic: H },
    K = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
    V = (e) => K[e];
  function W(e, t) {
    if (t) {
  ...
  class re {
    ...
    constructor(t) {
      ...
      (this.options.pedantic
        ? ((n.block = U.pedantic), (n.inline = J.pedantic))
        : this.options.gfm &&
          ((n.block = U.gfm),
